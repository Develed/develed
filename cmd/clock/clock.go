...
func (s *server) Write(ctx context.Context, req *srv.GenericRequest) (*srv.GenericResponse, error) {
	return &srv.GenericResponse{
		Code:   0,
		Status: "Ok",
	}, nil
}
...
func main() {
	...
	srv.RegisterGenericServer(s, drawing_srv)
